/* ============================================================
   ...
   {
     id:       "slug-unic-fara-diacritice",   // folosit în URL
     title:    "Titlul articolului",
     date:     "YYYY-MM-DD",
     category: "Categoria",                   // apare ca filtru
     tags:     ["tag1", "tag2"],
     image:    "images/poza.jpeg",            // sau URL extern
...
const ARTICLES = [
  {
    ...
    title: "Omida sfingidă pe roșii: prieten sau dușman?",
    date: "2024-07-15",
    category: "Viața din grădină",
    tags: ["insecte", "roșii", "permacultură", "biodiversitate"],
    image: "images/poza3.jpeg",
    author: "Laura",
    excerpt: "Am descoperit pe plantele de roșii o creatură impresionantă — omida sfingidă. Mare, verde, cu marcaje fascinante. Ce facem cu ea în grădina de permacultură?",
    content: `
      <p>Era o dimineață obișnuită de iulie când, controlând plantele de roșii, am dat peste ea: o omidă uriașă, aproape cât degetul meu, de un verde intens cu marcaje albastre și galbene pe corp și o față ce părea că zâmbește.</p>
      ...
      <p>Da, mănâncă din frunzele de roșii. Dar câteva frunze mâncate nu omoară o plantă sănătoasă. Iar fluturele adult care va ieși din ea va poleniza florile din grădină.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Câteva plante pe care le-am considerat „buruieni" s-au dovedit a fi exact ce avea nevoie terenul nostru. Pătlagina — un indicator de sol compactat, dar și o plantă medicinală valoroasă. Urzica — un semn de azot în sol, și un superaliment pentru compost.</p>
